...
python3 ../../Model_indep_FEATS/MultiLab/train.py ./input/$NAME_MODEL"."$T".conllu" ./model/$NAME_MODEL"."$T"morpho.pt" "./voc/"$NAME_MODEL"."$T"morpho.voc" $NB_IT $DIM_EMB
...
python3 ../../Model_indep_FEATS/MultiLab/decode.py ./model/$NAME_MODEL"."$T"morpho.pt" $FILE_TEST "./voc/"$NAME_MODEL"."$T"morpho.voc"  ./input/$NAME_MODEL"."$T".conllu.tagSet" > "./output/"$NAME_MODEL"."$T".auto.morpho.conllu"
...
python3 ../../Outils/conll18_ud_eval.py -v $FILE_TEST "./output/"$NAME_MODEL"."$T".auto.pos.conllu" > "../../Evaluation/Multilab/Model_Pipeline_FeatToPos/evaluation_fr_gsd-ud-test.conllu"

echo "Inférence des POS"
# Permet l'inférence sur le fichier de test
python3 decode.py ./model/$NAME_MODEL"."$T"pos.pt" $FILE_TEST "./voc/"$NAME_MODEL"."$T"pos.voc" > "./output/"$NAME_MODEL"."$T".auto.pos.conllu"

echo "Evaluation du modèle"
# Permet d'évaluer le modèle
python3 ../../Outils/conll18_ud_eval.py -v $FILE_TEST "./output/"$NAME_MODEL"."$T".auto.pos.conllu" > "../../Evaluation/Multilab/Model_Pipeline_FeatToPos/evaluation_fausse_fr_gsd-ud-test.conllu"
