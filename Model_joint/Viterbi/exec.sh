...
# Calcule les probabilité des bigrammes
...
python3 ../../Outils/conll18_ud_eval.py -v $FILE_TEST "./output/"$NAME_MODEL"."$T".auto.conllu"> "../../Evaluation/Viterbi/Model_joint/evaluation_fr_gsd-ud-test.conllu"
