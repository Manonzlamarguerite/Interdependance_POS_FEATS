...
python3 ../../Model_indep_FEATS/Baseline_multiLab/train.py ./input/$NAME_MODEL"."$T".conllu" ./model/$NAME_MODEL"."$T"morpho.pt" "./voc/"$NAME_MODEL"."$T"morpho.voc" $NB_IT $DIM_EMB
...
python3 ../../Model_indep_FEATS/Baseline_multiLab/decode.py ./model/$NAME_MODEL"."$T"morpho.pt" $FILE_TEST "./voc/"$NAME_MODEL"."$T"morpho.voc"  ./input/$NAME_MODEL"."$T".conllu.tagSet" > "./output/"$NAME_MODEL"."$T".auto.morpho.conllu"
