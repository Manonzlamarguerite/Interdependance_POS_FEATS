...
python3 train.py train.10.conllu train.10.pt train.10.voc train.10.big
echo "Fin de l'entraintement"

# Permet l'inférence sur le fichier de test
python3 decode.py train.10.pt fr_gsd-ud-test.conllu train.10.voc train.10.conllu.tagSet  > test.10.auto.conllu
echo "Evaluation du modèle"
# Permet d'évaluer le modèle
python3 conllu_eval.py fr_gsd-ud-test.conllu test.10.auto.conllu
