...
# Calcule les probabilité des bigrammes de POS
python3 conllu_bigrams.py ./input/$NAME_MODEL"."$T".conllu" "./big/"$NAME_MODEL"."$T".morpho.big"
echo "Début de l'entrainement FEATS"
# Entraine le modèle de prédiction de POS
python3 train.py ./input/$NAME_MODEL"."$T".conllu" ./model/$NAME_MODEL"."$T".morpho.pt" "./voc/"$NAME_MODEL"."$T".morpho.voc" ./big/$NAME_MODEL"."$T".morpho.big" $NB_IT $DIM_EMB
...
python3 ../../Model_indep_POS/Viterbi/decode.py ./model/$NAME_MODEL"."$T".pos.pt" $FILE_TEST "./voc/"$NAME_MODEL"."$T".pos.voc" > "./output/"$NAME_MODEL"."$T".auto.pos.conllu"
