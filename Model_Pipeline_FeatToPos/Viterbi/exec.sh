...
python3 ../../Outils/conll18_ud_eval.py -v $FILE_TEST "./output/"$NAME_MODEL"."$T".auto.pos.conllu" > "../../Evaluation/Viterbi/Model_Pipeline_FeatToPos/evaluation_fr_gsd-ud-test.conllu"

echo "Evaluation du modèle fausse (on donne les vrais POS)"
# Permet l'inférence sur le fichier de test
python3 decode.py ./model/$NAME_MODEL"."$T".pos.pt" $FILE_TEST "./voc/"$NAME_MODEL"."$T".pos.voc" ./input/$NAME_MODEL"."$T".conllu.tagSet" > "./output/"$NAME_MODEL"."$T".auto.pos.faux.conllu"
# Permet d'évaluer le modèle
python3 ../../Outils/conll18_ud_eval.py -v $FILE_TEST "./output/"$NAME_MODEL"."$T".auto.pos.faux.conllu" > "../../Evaluation/Viterbi/Model_Pipeline_FeatToPos/evaluation_fausse_fr_gsd-ud-test.conllu"
